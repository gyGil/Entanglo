...
--PERFORM dblink_exec('dbname=' || current_database(), 'CREATE DATABASE ' || quote_ident('Entanglo.Identity') || ' OWNER ggil');
...
FROM 'C:\Users\Owner\Source\Repos\EntangloWebService\EntangloWebService\EntangloDbScripts (Identity)\data\entanglo_word_rec.csv' DELIMITER ',';
